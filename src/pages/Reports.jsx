        ...
        <section className="report-section-block">
          <div className="section-heading-row">
            <div>
              ...
              <p>Estimated monthly financial projection breakdown</p>
            </div>
            <span className="calculated-badge">Calculated Data</span>
          </div>

          <div className="snapshot-grid">
            <div className="snapshot-card">
              <span>Monthly Revenue</span>
              <strong className="text-green">₹18,000</strong>
            </div>

            <div className="snapshot-card">
              <span>Monthly Expenses</span>
              <strong className="text-red">₹11,000</strong>
            </div>
